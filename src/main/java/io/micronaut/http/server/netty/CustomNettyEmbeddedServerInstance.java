 ...
 * @since 1.0
 */
@Replaces(NettyEmbeddedServerInstance.class)
@Prototype
class CustomNettyEmbeddedServerInstance implements EmbeddedServerInstance {

    private final String id;
    private final CustomNettyHttpServer nettyHttpServer;
    ...
    /**
     * @param id                              The id
     * @param nettyHttpServer                 The {@link CustomNettyHttpServer}
     ...
     */
    CustomNettyEmbeddedServerInstance(
        @Parameter String id,
        @Parameter CustomNettyHttpServer nettyHttpServer,
